 ...
 */
function ash_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['ash_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('ash sample setting'),
  '#default_value' => theme_get_setting('ash_example'),
