 ...
 */
function sethzen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['sethzen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('sethzen sample setting'),
  '#default_value' => theme_get_setting('sethzen_example'),
