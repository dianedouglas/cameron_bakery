 ...
 */
function better_zen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['better_zen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('better_zen sample setting'),
  '#default_value' => theme_get_setting('better_zen_example'),
