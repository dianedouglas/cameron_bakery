 ...
 */
function cameron_zen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['cameron_zen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('cameron_zen sample setting'),
  '#default_value' => theme_get_setting('cameron_zen_example'),
