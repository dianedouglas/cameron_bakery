 ...
 */
function zenmod_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['zenmod_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('zenmod sample setting'),
  '#default_value' => theme_get_setting('zenmod_example'),
