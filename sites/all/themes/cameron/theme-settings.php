 ...
 */
function cameron_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['cameron_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('cameron sample setting'),
  '#default_value' => theme_get_setting('cameron_example'),
