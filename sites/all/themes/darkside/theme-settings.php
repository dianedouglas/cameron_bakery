 ...
 */
function darkside_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['darkside_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('darkside sample setting'),
  '#default_value' => theme_get_setting('darkside_example'),
