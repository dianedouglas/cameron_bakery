 ...
 */
function zen_sub_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['zen_sub_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('zen_sub sample setting'),
  '#default_value' => theme_get_setting('zen_sub_example'),
